...
public class Utils {
	...
	public static void actionBar(final @NotNull Player p, final String msg, final float vol, final float pit,
	                             final Sound s) {
		p.spigot().sendMessage(ChatMessageType.ACTION_BAR, new TextComponent(msg));
		if (s != null) p.playSound(p.getLocation(), s, vol, pit);
	}

	public static @NotNull TextComponent getClickable(String msg, ClickEvent.Action a, String clickMsg,
