...
public class Sidebar {
	...
	public static void updateWorld(@NotNull Player p) {
		...
		Component worldComponent =
			  MiniMessage.miniMessage().deserialize(Color.GREEN.getColorMiniMessage() + StringUtils.capitalize(p.getWorld().getName()));
		String worldRow = legacySerializer.serialize(worldComponent);
	...
	public static void unsetScoreboard(@NotNull Player p) {
		...
		Component titleComponent = MiniMessage.miniMessage().deserialize(Color.LIGHT_BLUE.getColorMiniMessage() +
			  "ʜᴏʀɪᴢᴏɴ ᴍʏsᴇʀᴠᴇʀ");
